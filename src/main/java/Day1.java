    ...
    public static int partOne(String[] directions) {
        ...
        for (String direction : directions) {
            if (direction.charAt(0) == 'L') {
                ...
                System.out.println("Part One input is invalid");
                return -1;
            }
        ...
        System.out.println("Day1 Part One Result: " + res);
        return res;
    }
    ...
    public static int partTwo(String[] directions) {
        ...
        for (String direction : directions) {
            if (direction.charAt(0) == 'L') {
                ...
                System.out.println("Part Two input is invalid");
                return -1;
            }
            ...
            for (int i = 0; i < distance; i++) {
                ...
                if (visited.contains(cur)) {
                    int res = Math.abs(x) + Math.abs(y);
                    System.out.println("Day1 Part Two Result: " + res);
                    return res;
                } else {
                    visited.add(cur);
                }
